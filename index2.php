...
$db = new mysqli('localhost','host1024_tabele','hh4*77hjHHHu78','host1024_tabele');
 ...
 <a href="../adds/add_users.php">Добавить пользователя</a>
...
<span>id:  </span>
 ...
 if (confirm("Удалить?")) {
 location.href= '../delete/delete_in_manager_users.php?id_c=<? echo $resulte['id']; ?>';
} else {
  alert("Отменено")
}
 ...
 function update_in_manager_users<? echo $resulte['id'];?>(){
	 ...
	 location.href = '../update/update_users.php?id=<? echo $resulte['id'];?>';
 }
